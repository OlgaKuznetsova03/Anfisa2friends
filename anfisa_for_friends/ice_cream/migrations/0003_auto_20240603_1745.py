# Generated by Django 3.2.16 on 2024-06-03 14:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ice_cream', '0002_auto_20240602_1930'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='topping',
            name='slug',
            field=models.SlugField(help_text='Короткое название топпинга', max_length=64, unique=True, verbose_name='Слаг'),
        ),
        migrations.AlterField(
            model_name='topping',
            name='title',
            field=models.CharField(help_text='Название топпинга', max_length=256, verbose_name='Название'),
        ),
        migrations.AlterField(
            model_name='wrapper',
            name='title',
